  ...
  return (
    <div style={{ display: "grid", gridTemplateRows: "auto minmax(0, 1fr)" }}>
      ...
      >
        ...
        >
          {showSavedIcon && <Icon icon="check" size="small" />}
        </div>
        <div
          style={{
            display: "flex",
        ...
        >
          <IconButton icon="menu" onClick={onProjectMenuClick} />
          <Menu open={projectMenuButtonElement !== null} anchor={projectMenuButtonElement} onClose={onProjectMenuClose}>
            <MenuItem onClick={onNewProjectButtonClick} icon="new">
              New
            </MenuItem>
            <MenuItem onClick={onOpenProjectButtonClick} icon="open">
              Open
            </MenuItem>
            <MenuItem onClick={onRenameProjectButtonClick} icon="rename">
              Rename
            </MenuItem>
            <MenuItem disabled={!supportFileSystemAPI || !fileHandle} onClick={onSaveProjectButtonClick} icon="save">
              Save
            </MenuItem>
            <MenuItem disabled={!supportFileSystemAPI} onClick={onSaveAsProjectButtonClick} icon="saveas">
              Save As
            </MenuItem>
            <MenuItem onClick={onDownloadProjectButtonClick} icon="download">
              Download
            </MenuItem>
          </Menu>
        </div>
      ...
      >
        <div style={{ padding: "12px" }}>
          <IconButton icon="add" onClick={onAddDrawingButtonClick} />
        </div>
        <div
