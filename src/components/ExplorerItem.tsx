  ...
  const onDrawingNameClick = () => {
    ...
    if (panel) {
      updateBoardNavigation({
        type: "setPerspective",
        perspective: [panel.x - (x - boardNavigation.perspective[0]), panel.y - (y - boardNavigation.perspective[1])],
        duration: 300,
      });
    ...
    >
      ...
      <div>
        <IconButton
          ...
          onClick={onMenuClick}
        />
        <Menu open={menuButtonElement !== null} anchor={menuButtonElement} onClose={onMenuClose}>
          <MenuItem onClick={onExportButtonClick} icon="download">
            Export
          </MenuItem>
          <MenuItem onClick={onCloseButtonClick} icon="close">
            Close
          </MenuItem>
          <MenuItem onClick={onRenameButtonClick} icon="rename">
            Rename
          </MenuItem>
          <MenuItem onClick={onCopyButtonClick} icon="rename">
            Copy
          </MenuItem>
          <MenuItem onClick={onDeleteButtonClick} icon="delete">
            Delete
          </MenuItem>
        </Menu>
      </div>
