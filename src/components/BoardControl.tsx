...
export const BoardControl = (props: Props) => {
  ...
  return (
    ...
    >
      <IconButton icon="zoomout" size="small" onClick={onZoomOutButtonClick} />
      <IconButton icon="zoomin" size="small" onClick={onZoomInButtonClick} />
      {!props.toolBoxOpen && <IconButton icon="pen" size="small" onClick={onOpenToolBoxButtonClick} />}
    </div>
  );
};
